...
function tzoom_process_css($css, $theme) {
    ...
    $css = tzoom_set_menubackcolor($css, $menubackcolor);
    ...
    $css = tzoom_set_menuhovercolor($css, $menuhovercolor);
    ...
    $css = tzoom_set_backimage($css, $backimage);
    ...
    $css = tzoom_set_backposition($css,$backposition);
    ...
    $css = tzoom_set_backcolor($css, $backcolor);
    ...
    $css = tzoom_set_customcss($css, $customcss);
    
    return $css;
}

function tzoom_set_menubackcolor($css, $menubackcolor) {
...
function tzoom_set_menuhovercolor($css, $menuhovercolor) {
...
function tzoom_set_backimage($css, $backimage) {
	global $OUTPUT;  
...
function tzoom_set_backposition($css, $backposition = 'no-repeat', $tag = '[[setting:backposition]]'){
...
function tzoom_set_backcolor($css, $backcolor) {
...
function tzoom_set_logo($css, $logo) {
	global $OUTPUT;  
	$tag = '[[setting:logo]]';
	$replacement = $logo;
	$css = str_replace($tag, $replacement, $css);
...
function tzoom_set_customcss($css, $customcss) {
